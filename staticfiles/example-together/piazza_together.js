...
function init(){
    ...
    url_github="https://long-scene-5670.koishi.workers.dev/-----https://raw.githubusercontent.com/xyongcn/piazza-data-tsinghua.edu.cn_spring2015_30240243x/master/data/piazza-data-filter/piazza_my_feed.json";
    $.ajax({
        type : "get",
        cache : false,
        url : url_github , // 请求地址
    ...
    url_github="https://long-scene-5670.koishi.workers.dev/-----https://raw.githubusercontent.com/xyongcn/piazza-data-tsinghua.edu.cn_spring2015_30240243x/master/data/piazza-data/1.json";
    $.ajax({
        type : "get",
        cache : false,
        url : url_github , // 请求地址
...
function gen_multi_selector(obj,tags_arg){
    ...
    var label=opt.text;
    url_github="https://long-scene-5670.koishi.workers.dev/-----https://raw.githubusercontent.com/xyongcn/piazza-data-tsinghua.edu.cn_spring2015_30240243x/master/data/piazza-data-filter/filter_feed_"+label +".json";
    $.ajax({
        type : "get",
        cache : false,
        url : url_github , // 请求地址
...
function clickLi(cid)
{
    ...
    url_github="https://long-scene-5670.koishi.workers.dev/-----https://raw.githubusercontent.com/xyongcn/piazza-data-tsinghua.edu.cn_spring2015_30240243x/master/data/piazza-data/"+cid+".json";
    $.ajax({
        type : "get",
        cache : false,
        url : url_github , // 请求地址
...
function upd_feed(value,parent)
{
    ...
    url_github="https://long-scene-5670.koishi.workers.dev/-----https://raw.githubusercontent.com/xyongcn/piazza-data-tsinghua.edu.cn_spring2015_30240243x/master/data/piazza-data-filter/filter_feed_"+parent+".json";
    $.ajax({
        type : "get",
        cache : false,
        url : url_github , // 请求地址
